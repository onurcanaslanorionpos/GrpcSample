...
namespace GrpcChatSample2.Server.Grpc
{
    ...
    internal class ChatGrpcServer : IService
    {
        ...
        //private Host.CreateDefaultBuilder() m_app;
        ...
        public void Start()
        {
            ...
            webHost.ConfigureServices(service =>
            {
                ...
                service.AddSingleton(m_service);
                //service.AddSingleton(new IpAddressAuthenticator());
            ...
            }).ConfigureKestrel(serverOptions =>
                {
                ...
                }).Configure(app =>
                   {
                       ...
                       app.UseEndpoints(
                           endpoint =>
                           {
                               endpoint.MapGrpcService<ChatGrpcService>();
                           });
                   });

                var mm = webHost.Build();
